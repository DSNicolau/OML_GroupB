...
def fuzzy_clustering(n_clusters, data_np):
    cntr, u, u0, d, jm, p, fpc = fuzz.cluster.cmeans(
        data_np.transpose(), n_clusters, 2, error=0.005, maxiter=1000, init=None
    )
...
if __name__ == "__main__":
    ...
    for n_clusters in range(1, max_trials + 1):
        var_silh.append(fuzzy_clustering(n_clusters=n_clusters, data_np=data_np))
